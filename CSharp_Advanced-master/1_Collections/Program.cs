...
namespace ITEA_Collections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IBaseCollectionUsing collectionUsing2 = new GenericListUsing();
            collectionUsing2.Add("a");
            collectionUsing2.Add("2");
            collectionUsing2.Add("3");
            collectionUsing2.Add("4");
           
            collectionUsing2.AddMany(new[] { "123" });BaseUsingTest.Execute(ref collectionUsing2);
            #endregion
        }
